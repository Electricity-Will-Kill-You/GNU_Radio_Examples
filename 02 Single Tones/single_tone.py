...
class single_tone(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, Freq, 0.1, 0, 0)
...
def main(top_block_cls=single_tone, options=None):
