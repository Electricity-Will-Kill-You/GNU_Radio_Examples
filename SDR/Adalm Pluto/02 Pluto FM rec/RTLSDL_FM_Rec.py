...
class RTLSDL_FM_Rec(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "RTL_SDR_FM_Rec", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL_SDR_FM_Rec")
        ...
        self.settings = Qt.QSettings("GNU Radio", "RTLSDL_FM_Rec")
        ...
        labels = ['Filtered Real ', 'Filtered Im', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self._Tune_range = Range(88.7, 110.1, 0.2, 105.7, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_1.set_frequency_range(0, (self.samp_rate/5))
...
def main(top_block_cls=RTLSDL_FM_Rec, options=None):
