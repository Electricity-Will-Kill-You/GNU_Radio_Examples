...
class Pluto_Tx_to_Rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Pluto_Tx_to_Rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pluto_Tx_to_Rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Pluto_Tx_to_Rx")
        ...
        self._tone_freq_range = Range(-100e3, 100e3, 1, 50e3, 200)
        ...
        labels = ['Signal Source', 'PlutoSDR', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('ip:pluto.local' if 'ip:pluto.local' else iio.get_pluto_uri(), [True, True], 32768, False)
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_time_sink_x_0, 1))
...
def main(top_block_cls=Pluto_Tx_to_Rx, options=None):
