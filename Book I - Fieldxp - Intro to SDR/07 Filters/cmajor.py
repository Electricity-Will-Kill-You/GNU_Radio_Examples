...
class cmajor(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "cmajor", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("cmajor")
        ...
        labels = ['C Major', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 261.6, 0.1, 0, 0)
